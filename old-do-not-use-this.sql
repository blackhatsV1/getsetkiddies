...
CREATE TABLE `geofences` (
  ...
  CONSTRAINT `geofences_ibfk_1` FOREIGN KEY (`child_id`) REFERENCES `registered_children` (`id`)
...
CREATE TABLE `locations` (
  ...
  PRIMARY KEY (`id`),
  KEY `child_id` (`child_id`),
  CONSTRAINT `locations_ibfk_1` FOREIGN KEY (`child_id`) REFERENCES `registered_children` (`id`) ON DELETE CASCADE
...
CREATE TABLE `registered_children` (
  ...
  CONSTRAINT `registered_children_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `parents` (`id`) ON DELETE CASCADE,
  CONSTRAINT `registered_children_ibfk_2` FOREIGN KEY (`parent_id`) REFERENCES `parents` (`id`) ON DELETE CASCADE
